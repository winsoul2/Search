<div class="layout-content">
    <div class="layout-content-body">
		...
		<h1 style="margin-bottom: 0">รายงานสมาชิกขอซื้อหุ้นพิเศษ</h1>
		<?php $this->load->view('breadcrumb'); ?>
		<div class="row gutter-xs">
			<div class="col-xs-12 col-md-12">
				<div class="panel panel-body" style="padding-top:0px !important;">
					<form action="<?php echo base_url(PROJECTPATH.'/report_share_data/coop_report_members_buy_share_preview'); ?>" id="form1" method="GET" target="_blank">
						<h3></h3>
...
<?php
$link = array(
	'src' => PROJECTJSPATH.'assets/js/coop_report_members_buy_share.js',
