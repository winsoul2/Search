<div class="layout-content">
    <div class="layout-content-body">
        <style>
            ...
            #account_data_cash_table, #account_data_table {
                display: block;
                max-height: 250px;
                overflow-y:scroll;
            }
...
<div id="add_account_tran" tabindex="-1" role="dialog" class="modal fade" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-dialog-account">
        <div class="modal-content">
            <div class="modal-header modal-header-confirmSave">
...
<div id="add_account_cash" tabindex="-1" role="dialog" class="modal fade" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-dialog-account">
        <div class="modal-content">
            <div class="modal-header modal-header-confirmSave">
                <h2 class="modal-title">บันทึกรายการบัญชี</h2>
