<div class="layout-content">
    <div class="layout-content-body">
		...
		<h1 style="margin-bottom: 0">สรุปรายการรับชำระค่าหุ้นและเงินกู้ประจำเดือน</h1>
		<?php $this->load->view('breadcrumb'); ?>
		<div class="row gutter-xs">
			<div class="col-xs-12 col-md-12">
				<div class="panel panel-body" style="padding-top:0px !important;">
				<form action="<?php echo base_url('/report_summary_of_month/coop_report_summary_of_month_preview'); ?>" id="form1" method="GET" target="_blank">
					<h3></h3>
