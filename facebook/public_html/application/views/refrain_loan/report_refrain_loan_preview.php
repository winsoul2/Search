...
if(@$_GET['download']!=""){
     ...
     header("Content-Disposition: attachment; filename=รายงานการงดต้น/ดอกเบี้ยเงินกู้ ".$text_date.".xls"); 
...
<div style="width: 1000px;" class="page-break">
	<div class="panel panel-body" style="padding-top:10px !important;min-height: 1200px;">
		...
		?>	
			<tr>
				...
				<td class="text-center"	colspan="6">
						...
						<h3 class="title_view">รายงานการงดต้น/ดอกเบี้ยเงินกู้</h3>
						<h3 class="title_view">
						<?php
					...
					?>
					<a class="no_print"  target="_blank" href="<?php echo base_url(PROJECTPATH.'/refrain_loan/report_refrain_loan_preview'.$get_param.'&download=excel'); ?>">
		...
		<table class="table table-view table-center">
			<thead>
				<tr>
					<th style="width: 20px;vertical-align: middle;" class="table_header_top">ลำดับ</th>
					...
					<th style="width: 150px;vertical-align: middle;" class="table_header_top">ชื่อ-นามสกุล</th>
					<th style="width: 70px;vertical-align: middle;" class="table_header_top">สัญญาเลขที่</th>
					<th style="width: 70px;vertical-align: middle;" class="table_header_top">ประเภท</th>
					<th style="width: 80px;vertical-align: middle;" class="table_header_top">เดือน/ปี</th>
					<th style="width: 80px;vertical-align: middle;" class="table_header_top">รูปแบบงด</th>
			...
			?>
				<tr>
					...
					<td style="text-align: left;vertical-align: top;" class="table_body"><?php echo $row['contract_number'];?></td>
					<td style="text-align: center;vertical-align: top;" class="table_body"><?php echo (@$row['period_type'] == 1) ? "งดชั่วคราว" : "งดถาวร";?></td>
					<td style="text-align: center;vertical-align: top;mso-number-format:'\@'" class="table_body"><?php echo @$mmyy; ?></td>
					<td style="text-align: center;vertical-align: top;" class="table_body"><?php echo @$refrain_status[$row['refrain_type']]; ?></td>
