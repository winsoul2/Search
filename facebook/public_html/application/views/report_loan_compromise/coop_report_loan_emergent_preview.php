    ...
    <div style="width: 1500px;" class="page-break">
        <div class="panel panel-body" style="padding-top:20px !important;height: 100%;min-height: 1000px;">
                ...
                <tr>
                    ...
                    <td style="width:100px;vertical-align: top;" class="text-right">
                        <?php if($i == '1'){?>
                            ...
                            <a href="<?php echo base_url(PROJECTPATH.'/report_loan_compromise/coop_report_loan_emergent_excel?'.$param); ?>" class="no_print"><button class="btn btn-perview btn-after-input" type="button"><span>XLS</span></button></a>
                        <?php } ?>
                    </td>
                </tr>
                <tr>
            ...
            <table class="table table-view table-center">
                ...
                $this->db->join("coop_loan_name as t5", "t1.loan_type = t5.loan_name_id", "left");
                $this->db->join("coop_loan_type as t6", "t5.loan_type_id = t6.id", "left");
                $this->db->join("coop_loan_guarantee as t10", "t1.id = t10.loan_id", 'left');
                ...
                if(!empty($rs)){
                    ...
                    foreach($rs as $key => $row){
                        ...
                        if(@$row['guarantee_type']!=2){
                            ...
                            $text .= "ใช้หุ้น+กองทุนฯส่วนของพนักงานค้ำประกัน ";
                        }
