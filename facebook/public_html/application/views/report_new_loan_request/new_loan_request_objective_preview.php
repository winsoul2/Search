...
<!--                            <a href="--><?php //echo base_url(PROJECTPATH.'/report_new_loan_request/coop_report_loan_emergent_excel?'.$param); ?><!--" class="no_print"><button class="btn btn-perview btn-after-input" type="button"><span>XLS</span></button></a>-->
            ...
            <table class="table table-view table-center">
                <thead>
                <tr>
                    <th class="<?php echo @$_GET['download']!=""? "table_header_top":""?>" colspan="2" style="vertical-align: middle;">สังกัด</th>
                    <th class="<?php echo @$_GET['download']!=""? "table_header_top":""?>" colspan="2" style="vertical-align: middle;">จำนวนสัญญา</th>
                    <th class="<?php echo @$_GET['download']!=""? "table_header_top":""?>" rowspan="1" style="vertical-align: middle;">จำนวนเงินกู้</th>
                </tr>
                </thead>
                <tbody>
                <?php
                ...
                ?>
                <tr>
                    <td class="<?php echo @$_GET['download']!=""? "table_body":""?>" style="text-align: left;text-decoration:underline; " colspan = '5'>วันที่ขอกู้ : <?php echo $this->center_function->mydate2date($date);?></td>
                </tr>
                <?php
                ...
                <?php } ?>
                <tr>
                    <td class="<?php echo @$_GET['download']!=""? "table_body":""?>" style="text-align: right;" colspan="2">วันที่ขอกู้ : <?php echo $date;?></td>
...
<!--                    <td style="width: 350px;"></td>-->
                    <td class="<?php echo @$_GET['download']!=""? "table_body":""?>" style="width: 500px; text-align: right;"><h3 class="title_view"><?php echo "รวมทั้งหมด";?></h3></td>
                    ...
                    <td class="<?php echo @$_GET['download']!=""? "table_body":""?>" style="width: 150px;    text-align: center;"><h3 class="title_view"><?php echo number_format($all_loan_amount_total,2) .' บาท';?></h3></td>
