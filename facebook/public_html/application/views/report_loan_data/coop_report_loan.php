        ...
        <div class="row gutter-xs">
            <div class="col-xs-12 col-md-12">
                <div class="panel panel-body" style="padding-top:0px !important;">
                    <form action="<?php echo base_url(PROJECTPATH.'/report_loan_data/coop_report_loan_emergent_preview'); ?>" id="form1" name="form1" method="GET" target="_blank">
...
//                                            echo '<pre>';print_r($loan_name[$key]);exit;
                    ...
                    <form action="<?php echo base_url(PROJECTPATH.'/report_loan_data/coop_report_loan_emergent_preview'); ?>" id="form2" method="GET" target="_blank">
                        <div class="form-group g24-col-sm-24">
                            <div class="g24-col-sm-5 right">
                                <h3>รายเดือน</h3>
                            </div>
                    ...
                    <form action="<?php echo base_url(PROJECTPATH.'/report_loan_data/coop_report_loan_emergent_preview'); ?>" id="form3" method="GET" target="_blank">
                        <div class="form-group g24-col-sm-24">
                            <div class="g24-col-sm-5 right">
                                <h3>รายปี</h3>
                            </div>
...
$link = array(
    'src' => PROJECTJSPATH.'assets/js/coop_report_loan.js?v=1',
