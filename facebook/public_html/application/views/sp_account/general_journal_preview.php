                ...
                <tr>
                    ...
                    <td class="text-center">
                        <!-- <img src="<?php echo base_url(PROJECTPATH.'/assets/images/coop_profile/'.$_SESSION['COOP_IMG']); ?>" alt="Logo" style="height: 80px;" />	 -->
                            <h3 class="title_view"><?php echo @$cremation['full_name'];?></h3>
                        ...
                        ?>
                        <a class="no_print"  target="_blank" href="<?php echo base_url('/sp_account/'.$path.'/general_journal_excel'.$get_param); ?>">
