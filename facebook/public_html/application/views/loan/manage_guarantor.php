...
<script>
    ...
    $('#member_loan_search').click(function(){
        if($('#member_search_list').val() == '') {
            ...
            var loan_type_id = typeof $('#loan_type_id').val() == "undefined" ? '' : $('#loan_type_id').val();
            ...
            $.ajax({
                ...
                success:function(data) {
                    if(data=="FALSE"){
                        ...
                        var row = raw_obj = JSON.parse(data);
                        console.log(row);
						...
						for(let i in row){
							if(typeof row[i].contract_number != "undefined") {
								table += "<tr>";
								table += "<td>" + row[i].contract_number + "</td>";
								table += "<td>" + row[i].prename_short + row[i].firstname_th + " " + row[i].lastname_th + "</td>";
								table += "<td><button class='btn btn-success' onclick=\"init('" + row[i].contract_number + "')\">เลือก</button></td>";
								table += "</tr>";
							}
						}
